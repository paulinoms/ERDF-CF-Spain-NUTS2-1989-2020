# ==============================================================================
#
#  ERDF_CF_Spain_NUTS2_1989_2020 — European Structural and Cohesion Funds in Spain by NUTS2, Axis and Thematic Area, 1989-2020
#  Coverage period: 1989-2020 | 6 programming periods | 17 NUTS2 regions
#
...
# ------------------------------------------------------------------------------
#  DESCRIPTION
#  This script fully reproduces the certified expenditure database of the
#  European Structural and Cohesion Funds in Spain (ERDF + CF), disaggregated
#  by NUTS2 region, year of execution, axis and thematic area, for the
#  programming periods 1989-1993, 1994-1999, 2000-2006, 2007-2013 and
#  2014-2020. Figures are expressed in thousands of constant 2000 euros
#  (m_eur00) and thousands of constant 2020 euros (m_eur2020).
#
# ------------------------------------------------------------------------------
#  REPRODUCIBILITY
#  The script is self‑contained: it reads a single source Excel file and
#  generates all outputs deterministically. Monetary conversion factors are
#  hard‑coded and documented with their primary sources (EUROSTAT, INE),
#  making results reproducible without internet connection.
#
# ------------------------------------------------------------------------------
#  HOW TO CITE THIS WORK
#  If you use this database or script in a scholarly publication, please cite:
#
...
# ------------------------------------------------------------------------------
#  REPOSITORY FILES
#  ├── ERDF_CF_Spain_NUTS2_1989_2020_construction.R      <- This script
#  ├── data/
...
options(OutDec = ",", big.mark = ".")  # To avoid formatting warnings

# ------------------------------------------------------------------------------
# SECTION 1 · CONFIGURATION: WORKING DIRECTORY AND PACKAGES
# ------------------------------------------------------------------------------
# ADJUST this path to the directory where the source file is located
...
# Robust detection of the CPI sheet (tolerates Unicode variants)
hojas    <- excel_sheets(ARCHIVO)
hoja_ipc <- hojas[str_detect(hojas, "(?i)IPC|Ptas")][1]
cat("Hoja IPC detectada:", hoja_ipc, "\n\n")

# Helper: forces exactly 2 decimal places on all numeric columns
...
# ------------------------------------------------------------------------------
# CPI DEFLATOR €constant2000 → €constant2020
# ------------------------------------------------------------------------------
...
# EUR/ECU factors: rows 2-35, columns 9 and 10 of the Excel file
...
# Vectorized wrapper (only for constant unit)
...
# ------------------------------------------------------------------------------
# SECTION 3 · AXIS → THEMATIC AREA CLASSIFICATION TABLE (periods 1989-2006)
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# SECTION 4 · REG.89-93 — Regional ERDF 1989-1994
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# SECTION 5 · REG.94-99 — Regional ERDF 1994-2003
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# SECTION 6 · REG.00-06 — Regional ERDF 2001-2009
# ------------------------------------------------------------------------------
...
# Log of negative values (reimbursements)
neg_log_07 <- raw_0713 |>
...
# ------------------------------------------------------------------------------
# SECTION 10 · FINAL DATABASE: BD_FE_1989_2020
# ------------------------------------------------------------------------------
...
# Optional cross‑check against original "DB" sheet
...
# ------------------------------------------------------------------------------
# SECTION 12 · SUMMARY TABLES (robust version using base R)
# ------------------------------------------------------------------------------
...
# 12.2 Summary by area and period
...
# 12.3 Pivot table: NUTS2 × Year → columns = areas (€2000)
...
# 12.4 Pivot table in constant 2020 euros
...
# ------------------------------------------------------------------------------
# SECTION 13 · METADATA AND SOURCES TABLE
# ------------------------------------------------------------------------------
...
metadatos <- tribble(
  ...
  "Script",                  "ERDF_CF_Spain_NUTS2_1989_2020_construction.R",
...
# Force 2 decimal places on all tables
...
# Rename column "Anio" -> "Año" (base R, no conflicts)
